        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form" name="signup"  onsubmit="return validateAgreeTerms(this)" action="userRegistrationDB.php">
                        <h2 class="form-title">Create account</h2>
                        <div class="form-group">
                            <input type="text" class="form-input" name="u_name" id="u_name" placeholder="Your Full Name" title="Please Enter Your Name"autocomplete="off" onkeyup="javascript:capitalize(this.id, this.value);" required/>
                        </div>
					          	  <div class="form-group">
                            <input type="text" class="form-input" name="u_address" id="u_address" placeholder="Your Address" title="Please enter your address" autocomplete="off" required/>
                        </div>
						            <div class="form-group">
                            <input type="text" class="form-input" name="u_phone" id="u_phone" placeholder="Your Phone Number" autocomplete="off" minlength="10" maxlength="13" title="10 digit mobile number" onkeypress="PhoneCheck();" required />
                            <span id="print"></span>
                        </div>
						           <div class="form-group">
                            <input type="text" class="form-input" name="u_adhar" id="u_adhar" placeholder="Your Adhar Card Number" autocomplete="off" minlength="12" maxlength="12" title="12 digit adhar number" onkeypress="AdharCheck();" required />
                            <span id="print"></span>
                        </div>
                        ...
                        <div class="form-group">
                            <input type="email" class="form-input" name="u_email" id="u_email" placeholder="Your Email" title="Please enter your email"  onBlur="checkAvailability()" required/>
                        ...
                        <div class="form-group">
                            <input type="submit" name="registration" id="registration" class="form-submit" value="Sign up"/>
                        </div>
                    </form>
                    <p class="loginhere">
