...
<link href="https://cdn.jsdelivr.net/timepicker.js/latest/timepicker.min.css" rel="stylesheet"/>
	...
	<script>
    jQuery(function(){
      $("#includedFooter").load("includes/footer/footer_index.php");
    });
...
<body>
	...
	<div class="header">
		<div class="header_top">
			...
			<?php }else{
	         $_SESSION['blankActive'] = "404 not found";
					 ?>
				<div class="menu">
					<ul>
						<li class="active">
				...
				<div class="slider-wrapper theme-default">
					...
					<div>
						...
						<section>
						            <div class="container">
						                <div class="row">
						                  <form action="searchHall.php" method="post" name="searchForm">
						                      <div style = "position:absolute; left:347px; top:692px;">
						                          ...
						                          <div>
						                              <input type="date"  name="arr_date" value="" placeholder=""  autocomplete="on" onclick="isDateSelected();" required >
																	...
																	<div style = "position:absolute; left:548px; top:692px;">
																	  ...
																	  <div style = "position:absolute; left:741px; top:720px;">
