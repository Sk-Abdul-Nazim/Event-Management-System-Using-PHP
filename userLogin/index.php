            ...
            <div class="signup-content">
                <form method="POST" id="signin-form" class="signin-form" name="signin" onsubmit="return validateAgreeTerms(this)" action="loginDB.php">
                    ...
                    <div class="form-group">
                        <input type="email" class="form-input" name="u_email" id="u_email" placeholder="Email" title="Please enter your email" onkeyup="ValidateEmail();"  value="<?php echo $_SESSION['u_email'];?>" required/>
                        <span id="lblError"></span>
                    </div>
                    <div class="form-group">
                        <input type="password" class="form-input" name="password" id="password" placeholder="Password" value="<?php echo $_SESSION['u_pass'];?>" required/>
                    ...
                    <div class="form-group">
                        ...
                        <div style="visibility:hidden; color:#FF4000" id="agree_chk_error">
