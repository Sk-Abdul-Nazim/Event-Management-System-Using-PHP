 ...
 if(!isset($_SESSION["adminLoggedin"])){
  ...
  if(isset($_POST['editCat']))
  {
    $eid = $_POST['eid'];
     ...
     $sql = "UPDATE `category` SET category_name='$catname', category_date='$currDate', category_time='$currTime' WHERE category_id='$eid'";
               ...
               <div class="main">
                   <div class="container-fluid">
                       ...
                       <section id="main-content">
                            <h2 class="center">Update Category</h2>
                            <br>
                            ...
                            $id = $_REQUEST['id'];
                            $query="SELECT * FROM category WHERE category_id='$id' AND isActive=1";
                           ...
                           <section class="center">
                               <div>
                                   <div>
                                       <div>
                                           <input type="hidden" name="eid" value="<?php echo $row['category_id']?>">
                                           <lable>Category Name :</lable>
                                           <input type="text" name="catname" id="catname" placeholder="Enter Category Name" value="<?php echo $row['category_name']?>" onfocus="this.select();" onkeyup="javascript:capitalize(this.id, this.value);" autofocus required>
                                           </tr>
                                         </div>
                                       <br>
                                       <div>
                                           <input type="submit" name="editCat" Value="Submit">
