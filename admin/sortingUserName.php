...
<br>
                         ...
                         <table>
                           ...
                           if(isset($_GET['name'])){
                                ...
                                $query = "SELECT * FROM user_registration WHERE u_active=1 OR isActive=1 ORDER BY u_name";
                       ...
                       <?php
                         ...
                         <tr><td><?php echo $x; ?></td>
                             ...
                             <td>
                             <a style="text-decoration:none" href="javascript:void(0);" onclick="chk('<?php echo $row['u_id'] ?>');">Delete</a>
                             </td>
                       ...
                       if(isset($_GET['date'])){
                            ...
                            $query = "SELECT * FROM user_registration WHERE u_active=1 OR isActive=1 ORDER BY u_date";
                            $data= mysqli_query($conn,$query);
                            $total= mysqli_num_rows($data);
                            if($total!=0)
                            {
